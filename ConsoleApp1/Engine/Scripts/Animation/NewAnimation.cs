...
public class NewAnimation
{
    ...
    public NewAnimation(string name)
    {
        Name = name;
    }
...
public class GlobalKeyframe : AbstractKeyframe
{
    ...
    public GlobalKeyframe Lerp(Vector3 position, Quaternion rotation, Vector3 scale, float t)
    {
        return new GlobalKeyframe(Vector3.Lerp(Position, position, t), Quaternion.Slerp(Rotation, rotation, t), Vector3.Lerp(Scale, scale, t));
    }

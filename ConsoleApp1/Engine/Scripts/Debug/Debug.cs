...
public static class Debug
{
    ...
    public static void Start()
    {
        ...
        _mesh.Position = new Vector3(0, 0, 0);
        
        MeshHelper.GenerateMeshIndices(_mesh);
        _mesh.Uvs.AddRange(VoxelData.UVTable);

        _mesh.Vertices.Add(new Vector3(0, 0, 0));
        _mesh.Vertices.Add(new Vector3(0, 1, 0));
        _mesh.Vertices.Add(new Vector3(1, 1, 0));
        _mesh.Vertices.Add(new Vector3(1, 0, 0));
        
        _mesh.TextureIndices.Add(1);
        _mesh.TextureIndices.Add(1);
        _mesh.TextureIndices.Add(1);
        _mesh.TextureIndices.Add(1);
        ...
        _mesh.Vertices.Add(new Vector3(1, 0, 0));
        _mesh.Vertices.Add(new Vector3(1, 1, 0));
        _mesh.Vertices.Add(new Vector3(1, 1, 1));
        _mesh.Vertices.Add(new Vector3(1, 0, 1));
        
        _mesh.TextureIndices.Add(color);
        _mesh.TextureIndices.Add(color);
        _mesh.TextureIndices.Add(color);
        _mesh.TextureIndices.Add(color);
        ...
        _mesh.Vertices.Add(new Vector3(0, 1, 0));
        _mesh.Vertices.Add(new Vector3(0, 1, 1));
        _mesh.Vertices.Add(new Vector3(1, 1, 1));
        _mesh.Vertices.Add(new Vector3(1, 1, 0));
        ...
        _mesh.Vertices.Add(new Vector3(0, 0, 1));
        _mesh.Vertices.Add(new Vector3(0, 1, 1));
        _mesh.Vertices.Add(new Vector3(0, 1, 0));
        _mesh.Vertices.Add(new Vector3(0, 0, 0));

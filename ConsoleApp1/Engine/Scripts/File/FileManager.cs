...
public class FileManager : ScriptingNode
{
    ...
    public FileManager()
    {
        ...
        backgroundCollection.SetOnHoverEnter(() =>
        {
            IsHovering = true;
        });
        backgroundCollection.SetOnHoverExit(() =>
        {
            IsHovering = false;
        });
    ...
    public void GenerateElements(string path)
    {
        ...
        for (int i = 0; i < elementCount; i++)
        {
            ...
            UIButton fileButton = new UIButton("FileButton" + i, FilesUIController, AnchorType.TopLeft, PositionType.Relative, new Vector4(0.529f, 0.808f, 0.980f, 1.0f), (0, 0, 0), (300, 25), (0, 0, 0, 0), 0, 12, (7.5f, 0.05f), UIState.Interactable);

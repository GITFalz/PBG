...
public static class Ease
{
    ...
    {
        multiplier = Mathf.Clamp(0.1f, 4f, multiplier);
        return type switch
        {
            EasingType.Linear => t,

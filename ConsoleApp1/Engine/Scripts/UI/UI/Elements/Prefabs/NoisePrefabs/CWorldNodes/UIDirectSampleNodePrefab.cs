...
public class UIDirectSampleNodePrefab : UINoiseNodePrefab
{
    ...
    public UIButton InputPosX;
    public UIButton InputPosY;
    ...
    public UIInputField PosXInputField;
    public UIInputField PosYInputField;
    public UIInputField OffsetXInputField;
    public UIInputField OffsetYInputField;

    public UIText ScaleTextField;
    public UIText PosXTextField;
    public UIText PosYTextField;
    ...
    public Vector4 ButtonColor = DIRECT_SAMPLE_NODE_COLOR;
    ...
    public UIDirectSampleNodePrefab(string name, UIController controller, Vector4 offset) : base(name, controller, offset)
    {
        Scale = (300, 210);
        ...
        NameField.SetTextCharCount("Direct Sample", 1.2f).SetTextType(TextType.Alphanumeric);

        InputPosX = new UIButton($"{name}InputPosX", controller, AnchorType.BottomLeft, PositionType.Relative, (0.5f, 0.5f, 0.5f, 1f), (0, 0, 0), (20, 20), (0, -92, 0, 0), 0, 11, (10f, 0.05f), UIState.Interactable);
        InputPosY = new UIButton($"{name}InputPosY", controller, AnchorType.BottomLeft, PositionType.Relative, (0.5f, 0.5f, 0.5f, 1f), (0, 0, 0), (20, 20), (0, -62, 0, 0), 0, 11, (10f, 0.05f), UIState.Interactable);
        ...
        ScaleInputField = new UIInputField($"{name}ScaleInputField", controller, AnchorType.BottomRight, PositionType.Relative, (1f, 1f, 1f, 1f), (0, 0, 0), (20, 20), (-8, -126, 0, 0), 0, 11, (10f, 0.05f));
        ScaleInputField.SetMaxCharCount(10).SetText("1.0", 1.2f).SetTextType(TextType.Decimal);

        PosXInputField = new UIInputField($"{name}PosXInputField", controller, AnchorType.BottomRight, PositionType.Relative, (1f, 1f, 1f, 1f), (0, 0, 0), (20, 20), (-8, -96, 0, 0), 0, 11, (10f, 0.05f));
        PosXInputField.SetMaxCharCount(10).SetText("0.0", 1.2f).SetTextType(TextType.Decimal);

        PosYInputField = new UIInputField($"{name}PosYInputField", controller, AnchorType.BottomRight, PositionType.Relative, (1f, 1f, 1f, 1f), (0, 0, 0), (20, 20), (-8, -66, 0, 0), 0, 11, (10f, 0.05f));
        PosYInputField.SetMaxCharCount(10).SetText("0.0", 1.2f).SetTextType(TextType.Decimal);
        ...
        ScaleTextField = new UIText($"{name}ScaleTextField", controller, AnchorType.BottomLeft, PositionType.Relative, (1f, 1f, 1f, 1f), (0, 0, 0), (20, 20), (6, -126, 0, 0), 0);
        ScaleTextField.SetTextCharCount("Scale", 1.2f).SetTextType(TextType.Alphanumeric);

        PosXTextField = new UIText($"{name}PosXTextField", controller, AnchorType.BottomLeft, PositionType.Relative, (1f, 1f, 1f, 1f), (0, 0, 0), (20, 20), (30, -96, 0, 0), 0);
        PosXTextField.SetTextCharCount("X", 1.2f).SetTextType(TextType.Alphanumeric);

        PosYTextField = new UIText($"{name}PosYTextField", controller, AnchorType.BottomLeft, PositionType.Relative, (1f, 1f, 1f, 1f), (0, 0, 0), (20, 20), (30, -66, 0, 0), 0);
        PosYTextField.SetTextCharCount("Y", 1.2f).SetTextType(TextType.Alphanumeric);
        ...
        ElementCollection.AddElements(
            NameField,
            InputPosX, InputPosY, InputButton1, InputButton2,
            OutputButton,
            scaleBackground, posXBackground, posYBackground, offsetXBackground, offsetYBackground,
            ScaleInputField, PosXInputField, PosYInputField, OffsetXInputField, OffsetYInputField,
            ScaleTextField, PosXTextField, PosYTextField, OffsetXTextField, OffsetYTextField);
    ...
    {
        var node = new DirectSampleConnectorNode(this);
        connectorNode = node;
        noiseNodes.Add(this, node);
        inputGates.Add(node.InputPosXConnector);
        inputGates.Add(node.InputPosYConnector);

...
public class UIDisplayNodePrefab : UINoiseNodePrefab
{
    ...
    public Vector3 InputPosition => InputButton.Center;
    ...
    public UIDisplayNodePrefab(
        ...
        NameField = new UIText($"{name}Display", controller, AnchorType.TopLeft, PositionType.Relative, (0, 0, 0), (_scale.X - 14, 20), (6, 6, 0, 0), 0, textMesh);
        ...
        Background = new UIImage($"{name}Background", controller, AnchorType.TopLeft, PositionType.Relative, _backgroundColor, (0, 0, 0), (_scale.X, 50), (0, 14, 0, 0), 0, 10, (10f, 0.05f), uiMesh);
